...
githubLabel: 'component: bar-chart'
githubSource: packages/open-ui-kit/src/components/index.ts
---

# Bar Chart

<p class="description">Bar chart for comparing quantities against a common baseline.</p>

{{"component": "@mui/internal-core-docs/ComponentLinkHeader"}}

## Introduction

Bar Chart is part of the Open UI Kit Core public API.
...
```tsx
import { BarChart } from '@open-ui-kit/core';
```
...
Bar Chart is exported from `@open-ui-kit/core`.
Use the exported TypeScript props for implementation details and keep local overrides narrow.

| Prop | Type | Description |
| --- | --- | --- |
| `BarChart` props | Component-specific props | Controls the supported behavior, slots, state, and styling for Bar Chart. |
...
- [Storybook](https://main--68cc22452afe30d90e4ca977.chromatic.com/?path=/docs/charts-bar-chart--docs)
