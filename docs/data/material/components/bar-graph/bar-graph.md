...
title: React Bar Graph component
githubLabel: 'component: bar-graph'
githubSource: packages/open-ui-kit/src/components/index.ts
---

# Bar Graph

<p class="description">Stacked bar graph for grouped health, status, or distribution data.</p>

{{"component": "@mui/internal-core-docs/ComponentLinkHeader"}}

## Introduction

Bar Graph is part of the Open UI Kit Core public API.
...
```tsx
import { BarGraph } from '@open-ui-kit/core';
```
...
Bar Graph is exported from `@open-ui-kit/core`.
Use the exported TypeScript props for implementation details and keep local overrides narrow.

| Prop | Type | Description |
| --- | --- | --- |
| `BarGraph` props | Component-specific props | Controls the supported behavior, slots, state, and styling for Bar Graph. |
...
- [Storybook](https://main--68cc22452afe30d90e4ca977.chromatic.com/?path=/docs/charts-bar-graph--docs)
