...
title: React Chart Widget component
githubLabel: 'component: chart-widget'
githubSource: packages/open-ui-kit/src/components/index.ts
---

# Chart Widget

<p class="description">Dashboard widget shell for wrapping chart content with title, actions, and states.</p>

{{"component": "@mui/internal-core-docs/ComponentLinkHeader"}}

## Introduction

Chart Widget is part of the Open UI Kit Core public API.
...
```tsx
import { ChartWidget } from '@open-ui-kit/core';
```
...
Chart Widget is exported from `@open-ui-kit/core`.
Use the exported TypeScript props for implementation details and keep local overrides narrow.

| Prop | Type | Description |
| --- | --- | --- |
| `ChartWidget` props | Component-specific props | Controls the supported behavior, slots, state, and styling for Chart Widget. |
...
- [Storybook](https://main--68cc22452afe30d90e4ca977.chromatic.com/?path=/docs/charts-chart-widget--docs)
