...
<p class="description">Responsive page-width wrapper for keeping content aligned to a readable measure.</p>

{{"component": "@mui/internal-core-docs/ComponentLinkHeader"}}

## Introduction

Container is part of the Open UI Kit Core public API.
...
```tsx
import { Container } from '@open-ui-kit/core';
```
...
Container is exported from `@open-ui-kit/core`.
Use the exported TypeScript props for implementation details and keep local overrides narrow.

| Prop | Type | Description |
| --- | --- | --- |
| `Container` props | Component-specific props | Controls the supported behavior, slots, state, and styling for Container. |
