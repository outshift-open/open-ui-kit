...
githubLabel: 'component: donut-chart'
githubSource: packages/open-ui-kit/src/components/index.ts
---

# Donut Chart

<p class="description">Donut chart for proportional breakdowns and compact summary visuals.</p>

{{"component": "@mui/internal-core-docs/ComponentLinkHeader"}}

## Introduction

Donut Chart is part of the Open UI Kit Core public API.
...
```tsx
import { DonutChart } from '@open-ui-kit/core';
```
...
Donut Chart is exported from `@open-ui-kit/core`.
Use the exported TypeScript props for implementation details and keep local overrides narrow.

| Prop | Type | Description |
| --- | --- | --- |
| `DonutChart` props | Component-specific props | Controls the supported behavior, slots, state, and styling for Donut Chart. |
...
- [Storybook](https://main--68cc22452afe30d90e4ca977.chromatic.com/?path=/docs/charts-donut-chart--docs)
