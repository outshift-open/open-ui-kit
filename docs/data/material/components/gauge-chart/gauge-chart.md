...
githubLabel: 'component: gauge-chart'
githubSource: packages/open-ui-kit/src/components/index.ts
---

# Gauge Chart

<p class="description">Gauge chart for progress, score, and threshold-oriented visual summaries.</p>

{{"component": "@mui/internal-core-docs/ComponentLinkHeader"}}

## Introduction

Gauge Chart is part of the Open UI Kit Core public API.
...
```tsx
import { GaugeChart } from '@open-ui-kit/core';
```
...
Gauge Chart is exported from `@open-ui-kit/core`.
Use the exported TypeScript props for implementation details and keep local overrides narrow.

| Prop | Type | Description |
| --- | --- | --- |
| `GaugeChart` props | Component-specific props | Controls the supported behavior, slots, state, and styling for Gauge Chart. |
...
- [Storybook](https://main--68cc22452afe30d90e4ca977.chromatic.com/?path=/docs/charts-gauge-chart--docs)
