...
title: React Indicator Badge component
githubLabel: 'component: indicator-badge'
githubSource: packages/open-ui-kit/src/components/indicator-badge
---

# Indicator Badge

<p class="description">Small numeric or status indicator for dense product surfaces.</p>

{{"component": "@mui/internal-core-docs/ComponentLinkHeader"}}

## Introduction

Indicator Badge is part of the Open UI Kit Core public API.
...
Indicator Badge is exported from `@open-ui-kit/core`.
Use the exported TypeScript props for implementation details and keep local overrides narrow.

| Prop | Type | Description |
| --- | --- | --- |
| `IndicatorBadge` props | Component-specific props | Controls the supported behavior, slots, state, and styling for Indicator Badge. |
...
- [Storybook](https://main--68cc22452afe30d90e4ca977.chromatic.com/?path=/docs/components-indicatorbadge--docs)
- [Source](https://github.com/outshift-open/open-ui-kit/tree/main/packages/open-ui-kit/src/components/indicator-badge)
