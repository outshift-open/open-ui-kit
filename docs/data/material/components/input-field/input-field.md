...
title: React Input Field component
githubLabel: 'component: input-field'
githubSource: packages/open-ui-kit/src/components/input-field
---

# Input Field

<p class="description">Text entry control with Open UI Kit spacing, helper text, and state treatments.</p>

{{"component": "@mui/internal-core-docs/ComponentLinkHeader"}}

## Introduction

Input Field is part of the Open UI Kit Core public API.
...
```tsx
import { InputField } from '@open-ui-kit/core';
```

## When to use

Use Input Field for short text entry where users need labels, placeholders, helper text, and validation states.

## Anatomy

An input field includes a label, editable control, placeholder or value, helper text, and optional error state.
...
Input Field is exported from `@open-ui-kit/core`.
Use the exported TypeScript props for implementation details and keep local overrides narrow.

| Prop | Type | Description |
| --- | --- | --- |
| `InputField` props | Component-specific props | Controls the supported behavior, slots, state, and styling for Input Field. |
...
- [Storybook](https://main--68cc22452afe30d90e4ca977.chromatic.com/?path=/docs/components-inputfield--docs)
- [Source](https://github.com/outshift-open/open-ui-kit/tree/main/packages/open-ui-kit/src/components/input-field)
