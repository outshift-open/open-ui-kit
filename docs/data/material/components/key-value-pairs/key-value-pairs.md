...
title: React Key Value Pairs component
githubLabel: 'component: key-value-pairs'
githubSource: packages/open-ui-kit/src/components/key-value-pairs
---

# Key Value Pairs

<p class="description">Structured key-value rows for metadata, summaries, and detail panels.</p>

{{"component": "@mui/internal-core-docs/ComponentLinkHeader"}}

## Introduction

Key Value Pairs is part of the Open UI Kit Core public API.
...
```tsx
import { KeyValuePairs } from '@open-ui-kit/core';
```
...
Key Value Pairs is exported from `@open-ui-kit/core`.
Use the exported TypeScript props for implementation details and keep local overrides narrow.

| Prop | Type | Description |
| --- | --- | --- |
| `KeyValuePairs` props | Component-specific props | Controls the supported behavior, slots, state, and styling for Key Value Pairs. |
...
- [Storybook](https://main--68cc22452afe30d90e4ca977.chromatic.com/?path=/docs/components-keyvaluepairs--docs)
- [Source](https://github.com/outshift-open/open-ui-kit/tree/main/packages/open-ui-kit/src/components/key-value-pairs)
