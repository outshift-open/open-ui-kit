...
githubLabel: 'component: layout'
githubSource: packages/open-ui-kit/src/components/index.ts
---

# Layout

<p class="description">Application layout template for wrapping product navigation and page content.</p>

{{"component": "@mui/internal-core-docs/ComponentLinkHeader"}}

## Introduction

Layout is part of the Open UI Kit Core public API.
...
```tsx
import { Layout } from '@open-ui-kit/core';
```
...
Layout is exported from `@open-ui-kit/core`.
Use the exported TypeScript props for implementation details and keep local overrides narrow.

| Prop | Type | Description |
| --- | --- | --- |
| `Layout` props | Component-specific props | Controls the supported behavior, slots, state, and styling for Layout. |
...
- [Storybook](https://main--68cc22452afe30d90e4ca977.chromatic.com/?path=/docs/templates-layout--docs)
