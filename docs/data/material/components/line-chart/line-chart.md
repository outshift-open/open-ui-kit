...
githubLabel: 'component: line-chart'
githubSource: packages/open-ui-kit/src/components/index.ts
---

# Line Chart

<p class="description">Line chart for trends, time series, and changing values.</p>

{{"component": "@mui/internal-core-docs/ComponentLinkHeader"}}

## Introduction

Line Chart is part of the Open UI Kit Core public API.
...
Line Chart is exported from `@open-ui-kit/core`.
Use the exported TypeScript props for implementation details and keep local overrides narrow.

| Prop | Type | Description |
| --- | --- | --- |
| `LineChart` props | Component-specific props | Controls the supported behavior, slots, state, and styling for Line Chart. |
...
- [Storybook](https://main--68cc22452afe30d90e4ca977.chromatic.com/?path=/docs/charts-line-chart--docs)
