...
githubSource: packages/open-ui-kit/src/components/list
---

# List

<p class="description">Vertical list pattern for repeated rows with icons, secondary text, selection, dense, disabled, and divider states.</p>

{{"component": "@mui/internal-core-docs/ComponentLinkHeader"}}

## Introduction

List is part of the Open UI Kit Core public API.
...
```tsx
import { List } from '@open-ui-kit/core';
```
...
List is exported from `@open-ui-kit/core`.
Use the exported TypeScript props for implementation details and keep local overrides narrow.

| Prop | Type | Description |
| --- | --- | --- |
| `List` props | Component-specific props | Controls the supported behavior, slots, state, and styling for List. |
...
- [Storybook](https://main--68cc22452afe30d90e4ca977.chromatic.com/?path=/docs/components-list--docs)
- [Source](https://github.com/outshift-open/open-ui-kit/tree/main/packages/open-ui-kit/src/components/list)
