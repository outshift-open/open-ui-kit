...
title: React Loading Error State component
githubLabel: 'component: loading-error-state'
githubSource: packages/open-ui-kit/src/components/loading-error-state
---

# Loading Error State

<p class="description">API data-state wrapper that renders loading, error, empty, and ready content from one place.</p>

{{"component": "@mui/internal-core-docs/ComponentLinkHeader"}}

## Introduction

Loading Error State is part of the Open UI Kit Core public API.
...
```tsx
import { LoadingErrorState } from '@open-ui-kit/core';
```
...
Loading Error State is exported from `@open-ui-kit/core`.
Use the exported TypeScript props for implementation details and keep local overrides narrow.

| Prop | Type | Description |
| --- | --- | --- |
| `LoadingErrorState` props | Component-specific props | Controls the supported behavior, slots, state, and styling for Loading Error State. |
...
- [Storybook](https://main--68cc22452afe30d90e4ca977.chromatic.com/?path=/docs/components-loading-error-state--docs)
- [Source](https://github.com/outshift-open/open-ui-kit/tree/main/packages/open-ui-kit/src/components/loading-error-state)
