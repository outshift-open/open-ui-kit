...
title: React Loading States component
githubLabel: 'component: loading-states'
githubSource: packages/open-ui-kit/src/components/loading-states
---

# Loading States

<p class="description">Spinner and skeleton reference patterns for indeterminate progress and placeholder content.</p>

{{"component": "@mui/internal-core-docs/ComponentLinkHeader"}}

## Introduction

Loading States is part of the Open UI Kit Core public API.
...
```tsx
import { LoadingStates } from '@open-ui-kit/core';
```
...
Loading States is exported from `@open-ui-kit/core`.
Use the exported TypeScript props for implementation details and keep local overrides narrow.

| Prop | Type | Description |
| --- | --- | --- |
| `LoadingStates` props | Component-specific props | Controls the supported behavior, slots, state, and styling for Loading States. |
...
- [Storybook](https://main--68cc22452afe30d90e4ca977.chromatic.com/?path=/docs/components-loadingstates--docs)
- [Source](https://github.com/outshift-open/open-ui-kit/tree/main/packages/open-ui-kit/src/components/loading-states)
