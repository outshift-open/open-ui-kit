const synonyms = {
  ...
  AspectRatio:
    "dashed expand image monitor resize resolution scale screen square",
  Assessment:
  ...
  BorderBottom:
    "dashed doc editing editor spreadsheet stroke text type writing",
  ...
  Category:
    "categories circle collection items product shapes sort square triangle",
  ...
  Cloud:
    "climate connection internet network queue sky temperature upload weather",
  CloudCircle:
  ...
  CloudQueue:
    "climate connection internet network sky temperature upload weather",
  CloudSync:
  ...
  Copyright:
    "alphabet character circle emblem font legal letters owner symbol text",
  ...
  DeleteForever:
    "all bin cancel clear exit garbage junk recycle remove trashcan",
  ...
  Difference:
    "compare content copy cut document duplicate file multiple past stack",
  ...
  EditNote:
    "compose create draft editing input lines pencil text write writing",
  EditNotifications:
  ...
  FlutterDash:
    "application bird framework logo mascot open program software source",
  FmdBad:
  ...
  Gesture:
    "doodle drawing finger gestures hand line motion scribble string thread",
  ...
  GridOn:
    "background collage disabled enabled image layout off sheet slash view",
  GridView:
  ...
  KeyboardArrowUp:
    "arrows chevron collapse direction expandable less list submit",
  ...
  KeyOff:
    "[offline] access disabled door enabled entry on password slash unlock",
  KingBed:
  ...
  LocalFireDepartment:
    "911 climate firefighter flame heat home hot nest thermostat",
  ...
  MarkEmailUnread:
    "check circle envelop letters message note notification send",
  ...
  PrivateConnectivity:
    "locked password privacy protection safety secure security",
  ...
  ShareLocation:
    "dashed destination direction gps maps pin place stop tracking",
  ...
  Smartphone:
    "Android call cellphone chat device hardware iOS mobile tablet text",
  SmartScreen:
  ...
  SpeakerPhone:
    "Android audio cell device hardware iOS mobile sound tablet volume",
  Speed:
  ...
  Subscriptions:
    "enroll media order playlist queue signup stack subscribe youtube",
  Subtitles:
  ...
  TempleBuddhist:
    "buddha buddhism ideology monastery religion spiritual worship",
  ...
  TextIncrease:
    "+ add alphabet character font letters new plus resize symbol type",
  TextRotateUp:
    "A alphabet arrow character field font letters move symbol type",
  TextRotateVertical:
  ...
  TheaterComedy:
    "broadway event masks movie musical places show standup tour watch",
  ...
  Tonality:
    "circle editing filter greyscale image photography picture shade shadow",
