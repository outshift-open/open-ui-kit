...
githubSource: packages/open-ui-kit/src/components/menu
---

# Menu

<p class="description">Menu surfaces and items for contextual command groups.</p>

{{"component": "@mui/internal-core-docs/ComponentLinkHeader"}}

## Introduction

Menu is part of the Open UI Kit Core public API.
...
```tsx
import { Menu } from '@open-ui-kit/core';
```
...
Menu is exported from `@open-ui-kit/core`.
Use the exported TypeScript props for implementation details and keep local overrides narrow.

| Prop | Type | Description |
| --- | --- | --- |
| `Menu` props | Component-specific props | Controls the supported behavior, slots, state, and styling for Menu. |
...
- [Storybook](https://main--68cc22452afe30d90e4ca977.chromatic.com/?path=/docs/components-menu-menu--docs)
- [Source](https://github.com/outshift-open/open-ui-kit/tree/main/packages/open-ui-kit/src/components/menu)
