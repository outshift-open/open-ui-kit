...
githubLabel: 'component: message'
githubSource: packages/open-ui-kit/src/components/message
---

# Message

<p class="description">Short status message with success, error, warning, and info variants plus optional title, action, and dismiss control.</p>

{{"component": "@mui/internal-core-docs/ComponentLinkHeader"}}

## Introduction

Message is part of the Open UI Kit Core public API.
...
Message is exported from `@open-ui-kit/core`.
Use the exported TypeScript props for implementation details and keep local overrides narrow.

| Prop | Type | Description |
| --- | --- | --- |
| `Message` props | Component-specific props | Controls the supported behavior, slots, state, and styling for Message. |
...
- [Storybook](https://main--68cc22452afe30d90e4ca977.chromatic.com/?path=/docs/components-message--docs)
- [Source](https://github.com/outshift-open/open-ui-kit/tree/main/packages/open-ui-kit/src/components/message)
