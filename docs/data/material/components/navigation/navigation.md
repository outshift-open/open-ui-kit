...
githubLabel: 'component: navigation'
githubSource: packages/open-ui-kit/src/components/navigation
---

# Navigation

<p class="description">Navigation rail and drawer patterns for product IA.</p>

{{"component": "@mui/internal-core-docs/ComponentLinkHeader"}}

## Introduction

Navigation is part of the Open UI Kit Core public API.
...
```tsx
import { Navigation } from '@open-ui-kit/core';
```
...
Navigation is exported from `@open-ui-kit/core`.
Use the exported TypeScript props for implementation details and keep local overrides narrow.

| Prop | Type | Description |
| --- | --- | --- |
| `Navigation` props | Component-specific props | Controls the supported behavior, slots, state, and styling for Navigation. |
...
- [Storybook](https://main--68cc22452afe30d90e4ca977.chromatic.com/?path=/docs/components-navigation--docs)
- [Source](https://github.com/outshift-open/open-ui-kit/tree/main/packages/open-ui-kit/src/components/navigation)
