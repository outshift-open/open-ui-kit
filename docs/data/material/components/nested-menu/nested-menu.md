...
title: React Nested Menu component
githubLabel: 'component: nested-menu'
githubSource: packages/open-ui-kit/src/components/nested-menu
---

# Nested Menu

<p class="description">Nested menu for selecting items from hierarchical options.</p>

{{"component": "@mui/internal-core-docs/ComponentLinkHeader"}}

## Introduction

Nested Menu is part of the Open UI Kit Core public API.
...
```tsx
import { NestedMenu } from '@open-ui-kit/core';
```
...
Nested Menu is exported from `@open-ui-kit/core`.
Use the exported TypeScript props for implementation details and keep local overrides narrow.

| Prop | Type | Description |
| --- | --- | --- |
| `NestedMenu` props | Component-specific props | Controls the supported behavior, slots, state, and styling for Nested Menu. |
...
- [Storybook](https://main--68cc22452afe30d90e4ca977.chromatic.com/?path=/docs/components-menu-nestedmenu--docs)
- [Source](https://github.com/outshift-open/open-ui-kit/tree/main/packages/open-ui-kit/src/components/nested-menu)
