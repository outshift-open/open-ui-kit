...
title: React Overflow Tooltip component
githubLabel: 'component: overflow-tooltip'
githubSource: packages/open-ui-kit/src/components/overflow-tooltip
---

# Overflow Tooltip

<p class="description">Tooltip helper for text that may truncate in constrained layouts.</p>

{{"component": "@mui/internal-core-docs/ComponentLinkHeader"}}

## Introduction

Overflow Tooltip is part of the Open UI Kit Core public API.
...
Overflow Tooltip is exported from `@open-ui-kit/core`.
Use the exported TypeScript props for implementation details and keep local overrides narrow.

| Prop | Type | Description |
| --- | --- | --- |
| `OverflowTooltip` props | Component-specific props | Controls the supported behavior, slots, state, and styling for Overflow Tooltip. |
...
- [Storybook](https://main--68cc22452afe30d90e4ca977.chromatic.com/?path=/docs/components-overflow-tooltip--docs)
- [Source](https://github.com/outshift-open/open-ui-kit/tree/main/packages/open-ui-kit/src/components/overflow-tooltip)
