...
title: React Page Title component
githubLabel: 'component: page-title'
githubSource: packages/open-ui-kit/src/components/index.ts
---

# Page Title

<p class="description">Page title template for consistent headings, descriptions, and page actions.</p>

{{"component": "@mui/internal-core-docs/ComponentLinkHeader"}}

## Introduction

Page Title is part of the Open UI Kit Core public API.
...
```tsx
import { PageTitle } from '@open-ui-kit/core';
```
...
Page Title is exported from `@open-ui-kit/core`.
Use the exported TypeScript props for implementation details and keep local overrides narrow.

| Prop | Type | Description |
| --- | --- | --- |
| `PageTitle` props | Component-specific props | Controls the supported behavior, slots, state, and styling for Page Title. |
...
- [Storybook](https://main--68cc22452afe30d90e4ca977.chromatic.com/?path=/docs/templates-pagetitle--docs)
