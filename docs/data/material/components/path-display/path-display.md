...
title: React Path Display component
githubLabel: 'component: path-display'
githubSource: packages/open-ui-kit/src/components/path-display
---

# Path Display

<p class="description">Path display for file, route, or hierarchy strings.</p>

{{"component": "@mui/internal-core-docs/ComponentLinkHeader"}}

## Introduction

Path Display is part of the Open UI Kit Core public API.
...
```tsx
import { PathDisplay } from '@open-ui-kit/core';
```
...
Path Display is exported from `@open-ui-kit/core`.
Use the exported TypeScript props for implementation details and keep local overrides narrow.

| Prop | Type | Description |
| --- | --- | --- |
| `PathDisplay` props | Component-specific props | Controls the supported behavior, slots, state, and styling for Path Display. |
