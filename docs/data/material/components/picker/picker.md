...
title: React Picker Item component
githubLabel: 'component: picker'
githubSource: packages/open-ui-kit/src/components/picker
---

# Picker Item

<p class="description">Picker item primitives for compact choice surfaces.</p>

{{"component": "@mui/internal-core-docs/ComponentLinkHeader"}}

## Introduction

Picker Item is part of the Open UI Kit Core public API.
...
```tsx
import { PickerItem } from '@open-ui-kit/core';
```
...
Picker Item is exported from `@open-ui-kit/core`.
Use the exported TypeScript props for implementation details and keep local overrides narrow.

| Prop | Type | Description |
| --- | --- | --- |
| `PickerItem` props | Component-specific props | Controls the supported behavior, slots, state, and styling for Picker Item. |
...
- [Storybook](https://main--68cc22452afe30d90e4ca977.chromatic.com/?path=/docs/components-picker--docs)
- [Source](https://github.com/outshift-open/open-ui-kit/tree/main/packages/open-ui-kit/src/components/picker)
