...
githubLabel: 'component: scroll-area'
githubSource: packages/open-ui-kit/src/components/scroll-area
---

# Scroll Area

<p class="description">Scroll area wrapper for constrained panes and long content.</p>

{{"component": "@mui/internal-core-docs/ComponentLinkHeader"}}

## Introduction

Scroll Area is part of the Open UI Kit Core public API.
...
```tsx
import { ScrollArea } from '@open-ui-kit/core';
```
...
Scroll Area is exported from `@open-ui-kit/core`.
Use the exported TypeScript props for implementation details and keep local overrides narrow.

| Prop | Type | Description |
| --- | --- | --- |
| `ScrollArea` props | Component-specific props | Controls the supported behavior, slots, state, and styling for Scroll Area. |
...
- [Storybook](https://main--68cc22452afe30d90e4ca977.chromatic.com/?path=/docs/components-scroll-area--docs)
- [Source](https://github.com/outshift-open/open-ui-kit/tree/main/packages/open-ui-kit/src/components/scroll-area)
