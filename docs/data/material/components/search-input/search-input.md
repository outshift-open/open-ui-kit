...
title: React Search Input component
githubLabel: 'component: search-input'
githubSource: packages/open-ui-kit/src/components/search-input
---

# Search Input

<p class="description">Search field for filtering lists, tables, navigation, and command surfaces.</p>

{{"component": "@mui/internal-core-docs/ComponentLinkHeader"}}

## Introduction

Search Input is part of the Open UI Kit Core public API.
...
Search Input is exported from `@open-ui-kit/core`.
Use the exported TypeScript props for implementation details and keep local overrides narrow.

| Prop | Type | Description |
| --- | --- | --- |
| `SearchInput` props | Component-specific props | Controls the supported behavior, slots, state, and styling for Search Input. |
...
- [Storybook](https://main--68cc22452afe30d90e4ca977.chromatic.com/?path=/docs/components-search-input--docs)
- [Source](https://github.com/outshift-open/open-ui-kit/tree/main/packages/open-ui-kit/src/components/search-input)
