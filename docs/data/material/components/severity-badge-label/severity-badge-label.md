...
title: React Severity Badge Label component
githubLabel: 'component: severity-badge-label'
githubSource: packages/open-ui-kit/src/components/severity-badge-label
---

# Severity Badge Label

<p class="description">Severity indicator paired with a readable label, using the same enum and score system API as Severity Badge.</p>

{{"component": "@mui/internal-core-docs/ComponentLinkHeader"}}

## Introduction

Severity Badge Label is part of the Open UI Kit Core public API.
...
```tsx
import { SeverityBadgeLabel } from '@open-ui-kit/core';
```
...
Severity Badge Label is exported from `@open-ui-kit/core`.
Use the exported TypeScript props for implementation details and keep local overrides narrow.

| Prop | Type | Description |
| --- | --- | --- |
| `SeverityBadgeLabel` props | Component-specific props | Controls the supported behavior, slots, state, and styling for Severity Badge Label. |
...
- [Storybook](https://main--68cc22452afe30d90e4ca977.chromatic.com/?path=/docs/components-severity-badge-label--docs)
- [Source](https://github.com/outshift-open/open-ui-kit/tree/main/packages/open-ui-kit/src/components/severity-badge-label)
