...
title: React Severity Badge component
githubLabel: 'component: severity-badge'
githubSource: packages/open-ui-kit/src/components/severity-badge
---

# Severity Badge

<p class="description">Color indicator for severity enum values or numeric score systems with configurable thresholds.</p>

{{"component": "@mui/internal-core-docs/ComponentLinkHeader"}}

## Introduction

Severity Badge is part of the Open UI Kit Core public API.
...
```tsx
import { SeverityBadge } from '@open-ui-kit/core';
```
...
Severity Badge is exported from `@open-ui-kit/core`.
Use the exported TypeScript props for implementation details and keep local overrides narrow.

| Prop | Type | Description |
| --- | --- | --- |
| `SeverityBadge` props | Component-specific props | Controls the supported behavior, slots, state, and styling for Severity Badge. |
...
- [Storybook](https://main--68cc22452afe30d90e4ca977.chromatic.com/?path=/docs/components-severity-badge--docs)
- [Source](https://github.com/outshift-open/open-ui-kit/tree/main/packages/open-ui-kit/src/components/severity-badge)
