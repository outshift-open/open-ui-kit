...
title: React Severity Bar component
githubLabel: 'component: severity-bar'
githubSource: packages/open-ui-kit/src/components/severity-bar
---

# Severity Bar

<p class="description">Compact 4 by 32 pixel vertical color bar that communicates one severity level with minimal space.</p>

{{"component": "@mui/internal-core-docs/ComponentLinkHeader"}}

## Introduction

Severity Bar is part of the Open UI Kit Core public API.
...
```tsx
import { SeverityBar } from '@open-ui-kit/core';
```
...
Severity Bar is exported from `@open-ui-kit/core`.
Use the exported TypeScript props for implementation details and keep local overrides narrow.

| Prop | Type | Description |
| --- | --- | --- |
| `SeverityBar` props | Component-specific props | Controls the supported behavior, slots, state, and styling for Severity Bar. |
...
- [Storybook](https://main--68cc22452afe30d90e4ca977.chromatic.com/?path=/docs/components-severity-bar--docs)
- [Source](https://github.com/outshift-open/open-ui-kit/tree/main/packages/open-ui-kit/src/components/severity-bar)
