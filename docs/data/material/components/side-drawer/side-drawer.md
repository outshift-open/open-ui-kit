...
title: React Side Drawer component
githubLabel: 'component: side-drawer'
githubSource: packages/open-ui-kit/src/components/side-drawer
---

# Side Drawer

<p class="description">Drawer shell for secondary panels and side workflows.</p>

{{"component": "@mui/internal-core-docs/ComponentLinkHeader"}}

## Introduction

Side Drawer is part of the Open UI Kit Core public API.
...
| --- | --- | --- |
| `SideDrawer` props | Component-specific props | Controls the supported behavior, slots, state, and styling for Side Drawer. |
...
- [Storybook](https://main--68cc22452afe30d90e4ca977.chromatic.com/?path=/docs/components-sidedrawer--docs)
- [Source](https://github.com/outshift-open/open-ui-kit/tree/main/packages/open-ui-kit/src/components/side-drawer)
