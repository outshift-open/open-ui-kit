...
githubSource: packages/open-ui-kit/src/components/skeleton
---

# Skeleton

<p class="description">Skeleton placeholders that reserve layout while content loads.</p>

{{"component": "@mui/internal-core-docs/ComponentLinkHeader"}}

## Introduction

Skeleton is part of the Open UI Kit Core public API.
...
```tsx
import { Skeleton } from '@open-ui-kit/core';
```
...
Skeleton is exported from `@open-ui-kit/core`.
Use the exported TypeScript props for implementation details and keep local overrides narrow.

| Prop | Type | Description |
| --- | --- | --- |
| `Skeleton` props | Component-specific props | Controls the supported behavior, slots, state, and styling for Skeleton. |
...
- [Storybook](https://main--68cc22452afe30d90e4ca977.chromatic.com/?path=/docs/components-skeleton--docs)
- [Source](https://github.com/outshift-open/open-ui-kit/tree/main/packages/open-ui-kit/src/components/skeleton)
