...
githubLabel: 'component: spinner'
githubSource: packages/open-ui-kit/src/components/spinner
---

# Spinner

<p class="description">Spinner indicator for indeterminate loading.</p>

{{"component": "@mui/internal-core-docs/ComponentLinkHeader"}}

## Introduction

Spinner is part of the Open UI Kit Core public API.
...
Spinner is exported from `@open-ui-kit/core`.
Use the exported TypeScript props for implementation details and keep local overrides narrow.

| Prop | Type | Description |
| --- | --- | --- |
| `Spinner` props | Component-specific props | Controls the supported behavior, slots, state, and styling for Spinner. |
...
- [Storybook](https://main--68cc22452afe30d90e4ca977.chromatic.com/?path=/docs/components-spinner--docs)
- [Source](https://github.com/outshift-open/open-ui-kit/tree/main/packages/open-ui-kit/src/components/spinner)
