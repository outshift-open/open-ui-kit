...
title: React Stepper Modal component
githubLabel: 'component: stepper-modal'
githubSource: packages/open-ui-kit/src/components/stepper
---

# Stepper Modal

<p class="description">Dialog-style stepped workflow with a horizontal step series, title area, body content, and footer actions.</p>

{{"component": "@mui/internal-core-docs/ComponentLinkHeader"}}

## Introduction

Stepper Modal is part of the Open UI Kit Core public API.
...
```tsx
import { StepperModal } from '@open-ui-kit/core';
```
...
Stepper Modal is exported from `@open-ui-kit/core`.
Use the exported TypeScript props for implementation details and keep local overrides narrow.

| Prop | Type | Description |
| --- | --- | --- |
| `StepperModal` props | Component-specific props | Controls the supported behavior, slots, state, and styling for Stepper Modal. |
...
- [Storybook](https://main--68cc22452afe30d90e4ca977.chromatic.com/?path=/docs/components-stepper-steppermodal--docs)
