...
title: React Stepper Panel component
githubLabel: 'component: stepper-panel'
githubSource: packages/open-ui-kit/src/components/stepper
---

# Stepper Panel

<p class="description">Wizard-style panel with vertical steps, main content, optional footer actions, and a collapsible sidebar.</p>

{{"component": "@mui/internal-core-docs/ComponentLinkHeader"}}

## Introduction

Stepper Panel is part of the Open UI Kit Core public API.
...
```tsx
import { StepperPanel } from '@open-ui-kit/core';
```
...
Stepper Panel is exported from `@open-ui-kit/core`.
Use the exported TypeScript props for implementation details and keep local overrides narrow.

| Prop | Type | Description |
| --- | --- | --- |
| `StepperPanel` props | Component-specific props | Controls the supported behavior, slots, state, and styling for Stepper Panel. |
...
- [Storybook](https://main--68cc22452afe30d90e4ca977.chromatic.com/?path=/docs/components-stepper-stepperpanel--docs)
- [Source](https://github.com/outshift-open/open-ui-kit/tree/main/packages/open-ui-kit/src/components/stepper)
