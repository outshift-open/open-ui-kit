...
title: React Tags component
githubLabel: 'component: tags'
githubSource: packages/open-ui-kit/src/components/tags/tags
---

# Tags

<p class="description">Compact collection of tags with first-item summaries, overflow counts, truncation, and delete callbacks.</p>

{{"component": "@mui/internal-core-docs/ComponentLinkHeader"}}

## Introduction

Tags is part of the Open UI Kit Core public API.
...
```tsx
import { Tags } from '@open-ui-kit/core';
```
...
Tags is exported from `@open-ui-kit/core`.
Use the exported TypeScript props for implementation details and keep local overrides narrow.

| Prop | Type | Description |
| --- | --- | --- |
| `Tags` props | Component-specific props | Controls the supported behavior, slots, state, and styling for Tags. |
...
- [Storybook](https://main--68cc22452afe30d90e4ca977.chromatic.com/?path=/docs/components-tags-tags--docs)
- [Source](https://github.com/outshift-open/open-ui-kit/tree/main/packages/open-ui-kit/src/components/tags/tags)
