...
githubLabel: 'component: upload'
githubSource: packages/open-ui-kit/src/components/upload
---

# Upload

<p class="description">File upload surface for choosing, validating, and reviewing selected files.</p>

{{"component": "@mui/internal-core-docs/ComponentLinkHeader"}}

## Introduction

Upload is part of the Open UI Kit Core public API.
...
```tsx
import { Upload } from '@open-ui-kit/core';
```
...
Upload is exported from `@open-ui-kit/core`.
Use the exported TypeScript props for implementation details and keep local overrides narrow.

| Prop | Type | Description |
| --- | --- | --- |
| `Upload` props | Component-specific props | Controls the supported behavior, slots, state, and styling for Upload. |
...
- [Storybook](https://main--68cc22452afe30d90e4ca977.chromatic.com/?path=/docs/components-upload--docs)
- [Source](https://github.com/outshift-open/open-ui-kit/tree/main/packages/open-ui-kit/src/components/upload)
