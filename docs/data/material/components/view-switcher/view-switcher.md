...
title: React View Switcher component
githubLabel: 'component: view-switcher'
githubSource: packages/open-ui-kit/src/components/view-switcher
---

# View Switcher

<p class="description">View switcher for toggling between equivalent presentations.</p>

{{"component": "@mui/internal-core-docs/ComponentLinkHeader"}}

## Introduction

View Switcher is part of the Open UI Kit Core public API.
...
View Switcher is exported from `@open-ui-kit/core`.
Use the exported TypeScript props for implementation details and keep local overrides narrow.

| Prop | Type | Description |
| --- | --- | --- |
| `ViewSwitcher` props | Component-specific props | Controls the supported behavior, slots, state, and styling for View Switcher. |
...
- [Storybook](https://main--68cc22452afe30d90e4ca977.chromatic.com/?path=/docs/components-viewswitcher--docs)
- [Source](https://github.com/outshift-open/open-ui-kit/tree/main/packages/open-ui-kit/src/components/view-switcher)
