...
title: React Widget component
githubLabel: 'component: widget'
githubSource: packages/open-ui-kit/src/components/widget
---

# Widget

<p class="description">Composite card surface for metric, chart, and dashboard content with headline slots, actions, loading, and empty states.</p>

{{"component": "@mui/internal-core-docs/ComponentLinkHeader"}}

## Introduction

Widget is part of the Open UI Kit Core public API.
...
| --- | --- | --- |
| `Widget` props | Component-specific props | Controls the supported behavior, slots, state, and styling for Widget. |
...
- [Storybook](https://main--68cc22452afe30d90e4ca977.chromatic.com/?path=/docs/components-widget--docs)
- [Source](https://github.com/outshift-open/open-ui-kit/tree/main/packages/open-ui-kit/src/components/widget)
