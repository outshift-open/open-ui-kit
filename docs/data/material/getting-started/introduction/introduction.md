...
<p class="description">Open UI Kit Core gives product teams a ready-to-use React component library with Open UI Kit themes, tokens, and examples.</p>

## What Open UI Kit Core is

Open UI Kit Core is the package you install when you want flexible React components with stronger product defaults.
...
- **Flexible customization:** Use `sx`, slots, and theme overrides where local product needs require it.
