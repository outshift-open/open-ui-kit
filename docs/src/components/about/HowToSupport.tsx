    ...
    <Section cozy>
      ...
      <Grid container spacing={3}>
        <Grid size={{ xs: 12, sm: 6, md: 4 }}>
          ...
          >
            <Typography variant="body2" sx={{ color: "text.secondary", mb: 1 }}>
              ...
              with us! You can also up or downvote any page on our
              documentation. <br />
              <br /> And lastly, from time to time, we send our community a
              survey for more structured feedback, you&apos;re always invited to
        ...
        <Grid size={{ xs: 12, sm: 6, md: 4 }}>
          ...
          >
            <Typography variant="body2" sx={{ color: "text.secondary", mb: 1 }}>
              Become a member of a huge community of developers supporting MUI.
              You can:
            </Typography>
            <Box
              component="ul"
            ...
            >
              ...
              <li>
                ...
                <Link href="https://github.com/mui/material-ui/pulls">PRs</Link>{" "}
                and{" "}
                <Link href="https://github.com/mui/material-ui/issues">
                  issues
                </Link>
                .
              </li>
              <li>
                Help{" "}
                <Link href="https://crowdin.com/project/material-ui-docs">
                  translate
                </Link>{" "}
                the documentation.
              </li>
        ...
        <Grid size={{ xs: 12, sm: 6, md: 4 }}>
          ...
          >
            <Typography variant="body2" sx={{ color: "text.secondary", mb: 1 }}>
              If you use MUI in a commercial project and would like to support
              its continued development by becoming a Sponsor, or in a side or
              hobby project and would like to become a Backer, you can do so
              through {"Open Collective"}.
              <br />
              <br />
              All funds donated are managed transparently, and Sponsors receive
              recognition in the README and on the MUI home page.
            </Typography>
            <Button
              component="a"
              size="small"
