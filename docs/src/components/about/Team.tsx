      ...
      <Box data-mui-color-scheme="dark" sx={{ bgcolor: "common.black" }}>
        <Container sx={{ py: { xs: 4, sm: 8 } }}>
          ...
          <Typography sx={{ color: "text.secondary", maxWidth: { md: 500 } }}>
            Special members of the community deserve a shout-out for their
            ever-lasting impact on MUI&apos;s open-source projects.
          </Typography>
          ...
          <Typography sx={{ color: "text.secondary", maxWidth: { md: 500 } }}>
            We honor some no-longer-active core team members who have made
            valuable contributions in the past. They advise us from time to
            time.
          </Typography>
          <Grid container spacing={2} sx={{ mt: 2 }}>
            {emeriti.map((profile) => (
