...
import ShowcaseContainer, {
  ShowcaseCodeWrapper,
} from "docs/src/components/home/ShowcaseContainer";
import PointerContainer, {
  Data,
} from "docs/src/components/home/ElementPointer";
import {
  MoreInfoBox,
...
export default function CoreShowcase() {
  ...
  const [element, setElement] = React.useState<Data>({
    id: null,
    name: null,
    target: null,
  });
  ...
  if (highlightedLines !== null) {
    startLine = Array.isArray(highlightedLines)
      ? highlightedLines[0]
      : highlightedLines;
