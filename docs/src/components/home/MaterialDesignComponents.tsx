...
import {
  getDesignTokens,
  getThemedComponents,
} from "@mui/internal-core-docs/branding";
      ...
      MuiButton: {
        ...
        styleOverrides: {
            ...
            variants: [
              {
                props: { size: "small" },
                style: {
                  [`& .${buttonClasses.icon}`]: { fontSize: "0.875rem" },
                },
              },
              {
                props: { size: "medium" },
          ...
          contained: ({ theme }) => ({
            ...
            boxShadow:
              "0 2px 0 rgba(255,255,255,0.1) inset, 0 -1px 0 rgba(0,0,0,0.1) inset",
            border: "1px solid",
      ...
      <Grid>
        ...
        <div>
          <Demo
            ...
            control={{
              prop: "variant",
              values: ["outlined", "standard", "filled"],
            }}
          >
            <TextField
              id="material-design-textfield"
              label="Username"
