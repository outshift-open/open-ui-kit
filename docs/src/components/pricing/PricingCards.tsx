...
import {
  MultiAppProvider,
  useMultiApp,
} from "docs/src/components/pricing/MultiAppContext";
...
> = {
  ...
  pro: {
    ...
    title: "Pro",
    description:
      "Best for professional developers or startups building data-rich applications.",
    features: [
      {
        primaryLabel: (
          <React.Fragment>{highlightText("Pro")} support</React.Fragment>
        ),
        icon: "support",
        supportType: "pro",
      },
      {
        primaryLabel: (
          <React.Fragment>MUI X {highlightText("Pro")} access</React.Fragment>
        ),
        icon: "check",
      },
      {
        primaryLabel: (
          <React.Fragment>10+ {highlightText("Pro")} features</React.Fragment>
        ),
        icon: "check",
      },
    ],
  ...
  premium: {
    ...
    features: [
      {
        primaryLabel: (
          <React.Fragment>{highlightText("Premium")} support</React.Fragment>
        ),
        icon: "support",
        supportType: "premium",
      },
      { primaryLabel: "Access new features first", icon: "check" },
      {
        primaryLabel: (
          <React.Fragment>
            5+ {highlightText("Premium")} features
          </React.Fragment>
        ),
        icon: "check",
      },
  ...
  enterprise: {
    ...
    features: [
      {
        primaryLabel: (
          <React.Fragment>{highlightText("Priority")} support</React.Fragment>
        ),
        icon: "support",
...
export const multiAppPlanInfo: Partial<Record<PlanName, Feature[]>> = {
  ...
  premium: [
    ...
    {
      primaryLabel: (
        <React.Fragment>MUI X {highlightText("Premium")} access</React.Fragment>
      ),
      icon: "check",
    },
    {
      primaryLabel: (
        <React.Fragment>5+ {highlightText("Premium")} features</React.Fragment>
      ),
      icon: "check",
    },
  ],
    ...
    >
      ...
      >
        <Typography
          variant="h3"
          component="div"
          sx={{ fontWeight: "semiBold", color: priceColor }}
        >
...
export function PlanPrice(props: PlanPriceProps) {
  ...
  const getPriceExplanation = (displayedValue: number) => {
    if (annual) {
      return (
        <React.Fragment>
          Equivalent to <strong>${displayedValue.toFixed(2)}</strong> / month /
          dev
        </React.Fragment>
      );
    }
