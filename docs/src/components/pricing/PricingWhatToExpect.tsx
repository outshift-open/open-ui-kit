  ...
  return (
    <Section cozy>
      ...
      >
        <Paper
          variant="outlined"
          sx={{ p: 2, height: "fit-content", gridColumn: "span 1" }}
        >
          ...
          <Typography variant="body2" sx={{ color: "text.secondary" }}>
            ...
            front-end code of the projects that use the software.
            <br />
            <br />
        ...
        <Paper variant="outlined" sx={{ p: 2, height: "fit-content" }}>
          ...
          >
            ...
            licensed versions forever in production and development. It comes
            with 12 months of maintenance (free updates & support).
            <br />
            <br />
            Upon expiration, you can renew your maintenance plan with a discount
            that depends on when you renew:
            <ul>
        ...
        <Paper variant="outlined" sx={{ p: 2, height: "fit-content" }}>
          ...
          <Typography variant="body2" sx={{ color: "text.secondary" }}>
            On both license models, any version released before the end of your
            license term is forever available for applications deployed in
            production.
            <br />
            <br />
            The difference regards the right to use the components for{" "}
            <strong>development</strong> purposes. Only the perpetual license
            model allows you to continue development once your license expires.
          </Typography>
        </Paper>
        <Paper variant="outlined" sx={{ p: 2, height: "fit-content" }}>
          <Box sx={{ display: "flex", alignItems: "center", gap: 1, mb: 1 }}>
          ...
          <Typography variant="body2" sx={{ color: "text.secondary" }}>
            ...
            software in development. You will need to renew your license if you
            wish to continue active development after your current license term
            expires.
            <br />
            <br />
            The license is perpetual in production so you {"don't"} need to
            renew your license if you have stopped active development with the
        ...
        <Paper variant="outlined" sx={{ p: 2, height: "fit-content" }}>
          ...
          <Typography variant="body2" sx={{ color: "text.secondary" }}>
            With your purchase, you receive support and access to new versions
            for the duration of your subscription. You can{" "}
            ...
            <br />
            <br />
            Note that, except for critical issues, such as security flaws, we
            release bug fixes and other improvements on top of the latest
            version, instead of patching older versions.
          </Typography>
        </Paper>
        <Paper variant="outlined" sx={{ p: 2, height: "fit-content" }}>
          <Box sx={{ display: "flex", alignItems: "center", gap: 1, mb: 1 }}>
          ...
          <Typography variant="body2" sx={{ color: "text.secondary" }}>
            ...
            <Link href="mailto:sales@mui.com">sales team</Link> for a volume
            discount.
          </Typography>
        </Paper>
        <Paper variant="outlined" sx={{ p: 2, height: "fit-content" }}>
          ...
          <Typography variant="body2" sx={{ color: "text.secondary" }}>
            To continue providing the best service, MUI may implement an annual
            price increase of up to 7% at the time of renewal.
          </Typography>
        </Paper>
      </Box>
    </Section>
