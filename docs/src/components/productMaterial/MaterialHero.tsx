      ...
      left={
        <Box sx={{ textAlign: { xs: "center", md: "left" } }}>
          ...
          <Typography sx={{ color: "text.secondary", mb: 3, maxWidth: 500 }}>
            ...
            implements Google&apos;s Material Design. It&apos;s comprehensive
            and can be used in production out of the box.
          </Typography>
          <GetStartedButtons
            ...
            <Stack spacing={4} useFlexGap>
              <div>
                ...
                >
                  ...
                  <AccordionDetails>
                    <Typography variant="body2">
                      Material UI components work in isolation. They are
                      self-contained, and will only inject the styles they need
                      to display.
                    </Typography>
                  </AccordionDetails>
                </Accordion>
                <Accordion elevation={0} variant="outlined" disableGutters>
                  ...
                  <AccordionDetails>
                    <Typography variant="body2">
                      Material UI understands a handful of important globals
