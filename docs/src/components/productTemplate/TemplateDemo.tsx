...
import {
  ...
  icons,
  TEMPLATES,
} from "docs/src/components/productMaterial/MaterialTemplates";
          ...
          <SectionHeadline
            ...
            title={
              <Typography variant="h2">
                ...
                <GradientText>specific use case</GradientText>
              </Typography>
            }
                  ...
                  {templates.map((item, index) => (
                    <Box
                      ...
                      sx={(theme) => ({
                        ...
                        transform:
                          templateIndex !== index ? "scale(0.92)" : "scale(1)",
                        ...theme.applyDarkStyles({
                    ...
                    >
                      <Link
                        ...
                        sx={{
                          ...
                          left: 0,
                          bgcolor: (theme) =>
                            alpha(theme.palette.primaryDark[900], 0.4),
                          color: "#fff",
                          display: "flex",
                          alignItems: "center",
                    ...
                    <ActionArea
                      ...
                      onClick={() =>
                        setTemplateIndex((current) =>
                          Math.min(templates.length - 1, current + 1),
                        )
                      }
                      sx={{
                        right: 0,
