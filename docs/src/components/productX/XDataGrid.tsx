...
const dataGridStyleOverrides = (
  <XGridGlobalStyles selector="#data-grid-demo" pro />
);
          ...
          <SectionHeadline
            ...
            title={
              <Typography variant="h2">
                A level of <GradientText>performance and quality</GradientText>{" "}
              ...
              >
                <React.Fragment>
                  ...
                  >
                    ...
                    {demo === DEMOS[4] &&
                      "Multi-column filtering is a paid feature!"}
                  </Typography>
                  <Typography variant="body2" sx={{ color: "grey.300" }}>
                    The Data Grid and all other MUI X components are available
                    on free and paid plans. Find more details about each plan
                    and its features are on{" "}
