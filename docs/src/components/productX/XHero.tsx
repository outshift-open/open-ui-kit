      ...
      left={
        <Box sx={{ textAlign: { xs: "center", md: "left" } }}>
          ...
          <Typography sx={{ color: "text.secondary", mb: 3, maxWidth: 500 }}>
            Build complex and data-rich applications using a growing list of
            advanced React components, like the Data Grid, Date and Time
            Pickers, Charts, and more!
          </Typography>
          <GetStartedButtons
              ...
              sx={[
                {
                  borderColor: "divider",
                  boxShadow: (theme) =>
                    `0px 4px 12px ${alpha(theme.palette.grey[200], 0.6)}`,
                  "& > div": {
                    borderRadius: 1,
                    overflow: "auto",
