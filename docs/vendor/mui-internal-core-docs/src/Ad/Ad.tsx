...
const disableAd =
  ...
  process.env.ENABLE_AD_IN_DEV_MODE !== "true";
const inHouseAds = [
  {
    name: "templates",
    ...
    description:
      "Start your project with the best templates for admins, dashboards, and more.",
  },
  {
    name: "themes",
  ...
  },
  {
    ...
    description:
      "Save time and reduce risk. Managed open source — backed by maintainers.",
  },
  {
    name: "figma",
