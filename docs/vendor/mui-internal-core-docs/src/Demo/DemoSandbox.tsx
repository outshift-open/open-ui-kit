...
function FramedDemo(props: FramedDemoProps) {
  ...
  const cache = React.useMemo(
    () =>
      createCache({
        ...
        stylisPlugins:
          theme.direction === "rtl" ? [prefixer, rtlPlugin] : [prefixer],
      }),
  ...
  const Wrapper =
    IframeWrapper === undefined ? MaterialIframeWrapper : IframeWrapper;
      ...
      if (
        typeof (
          window as unknown as {
            getInjectTheme?: () => () => Record<string, unknown>;
          }
