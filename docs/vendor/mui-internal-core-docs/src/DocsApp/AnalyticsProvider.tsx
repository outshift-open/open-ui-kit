...
export function CookieConsentDialog() {
  const { needsConsent, setAnalyticsConsent, setEssentialOnly } =
    useAnalyticsConsent();
              ...
              >
                ...
                <Stack spacing={0.5}>
                  ...
                  <Typography
                    ...
                    sx={{ textAlign: { xs: "center", sm: "start" } }}
                  >
                    We use cookies to understand site usage and improve our
                    content. This includes third-party analytics.
                  </Typography>
                </Stack>
              </Stack>
