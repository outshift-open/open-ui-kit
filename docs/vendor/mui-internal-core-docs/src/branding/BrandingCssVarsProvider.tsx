...
export function setDocsColors(
  ...
  function injectPalette(
    ...
    const contrastText =
      getContrastRatio(color, "#fff") >= 3 ? "#fff" : "rgba(0, 0, 0, 0.87)";
...
export function BrandingCssVarsProvider(props: {
  ...
  return (
    <BrandingCssThemeProvider
      direction={direction}
      forceThemeRerender={
        canonicalAs.startsWith("/x/") || canonicalAs.startsWith("/toolpad/")
      }
    >
      <NextNProgressBar />
      <CssBaseline />
