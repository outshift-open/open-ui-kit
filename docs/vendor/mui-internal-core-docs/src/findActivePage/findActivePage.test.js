...
describe("findActivePage", () => {
  describe("old structure", () => {
    ...
    it("return first level page", () => {
      expect(
        findActivePage(pages, "/getting-started").activePage,
      ).to.deep.equal({
        pathname: "/getting-started",
        icon: "DescriptionIcon",
        children: [{ pathname: "/getting-started/installation" }],
    ...
    it("return nested page", () => {
      expect(
        findActivePage(pages, "/getting-started/installation").activePage,
      ).to.deep.equal({
    ...
    it("return deep nested page", () => {
      expect(
        findActivePage(pages, "/components/radio-buttons").activePage,
      ).to.deep.equal({
  ...
  describe("new structure", () => {
        ...
        children: [
          {
            ...
            children: [
              ...
              {
                pathname: "/material-ui/react-text-fields",
                title: "Text field",
              },
    ...
    it("return deep nested page", () => {
      expect(
        findActivePage(pages, "/material-ui/react-radio-buttons").activePage,
      ).to.deep.equal({
        pathname: "/material-ui/react-radio-buttons",
        title: "Radio button",
      });
