...
import { NestedMenu, useNestedMenu } from "../components/nested-menu";
...
interface NestedMenuStoryProps {
...
export const Default: Story = {
  render: () => (
    <NestedMenuStory parentNodesCount={100} childNodesStressLevels={3} />
  ),
};
