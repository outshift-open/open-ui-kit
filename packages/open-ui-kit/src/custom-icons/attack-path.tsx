...
/**
 * @deprecated Use `AttackPath` from `Icons` (packages/open-ui-kit/src/icons) instead.
 * This legacy version remains available via `LegacyIcons.AttackPath`.
 */
  ...
  return (
    <SvgIcon {...props}>
      <svg
        ...
        fill="none"
      >
        <path fill="currentColor" d="M18 10.5a4 4 0 1 0 0-8 4 4 0 0 0 0 8Z" />
        <path
          fill="currentColor"
          fillRule="evenodd"
