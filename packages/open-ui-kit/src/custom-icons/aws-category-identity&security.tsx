 ...
 * No direct replacement has been identified for `AWSCategoryIdentitySecurity` yet — it remains available via
 * `LegacyIcons.AWSCategoryIdentitySecurity` until migrated.
 */
