 ...
 * No direct replacement has been identified for `AWSServicesAutoScalingGroup` yet — it remains available via
 * `LegacyIcons.AWSServicesAutoScalingGroup` until migrated.
 */
