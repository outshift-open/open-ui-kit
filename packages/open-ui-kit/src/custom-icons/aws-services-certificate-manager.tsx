 ...
 * No direct replacement has been identified for `AWSServicesCertificateManager` yet — it remains available via
 * `LegacyIcons.AWSServicesCertificateManager` until migrated.
 */
