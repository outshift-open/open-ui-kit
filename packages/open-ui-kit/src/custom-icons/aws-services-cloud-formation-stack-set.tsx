 ...
 * No direct replacement has been identified for `AWSServicesCloudFormationStackSet` yet — it remains available via
 * `LegacyIcons.AWSServicesCloudFormationStackSet` until migrated.
 */
