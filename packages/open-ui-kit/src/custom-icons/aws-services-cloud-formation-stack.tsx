 ...
 * No direct replacement has been identified for `AWSServicesCloudFormationStack` yet — it remains available via
 * `LegacyIcons.AWSServicesCloudFormationStack` until migrated.
 */
