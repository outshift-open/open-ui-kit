 ...
 * No direct replacement has been identified for `AWSServicesCloudFormation` yet — it remains available via
 * `LegacyIcons.AWSServicesCloudFormation` until migrated.
 */
