 ...
 * No direct replacement has been identified for `AWSServicesDatabaseMigration` yet — it remains available via
 * `LegacyIcons.AWSServicesDatabaseMigration` until migrated.
 */
