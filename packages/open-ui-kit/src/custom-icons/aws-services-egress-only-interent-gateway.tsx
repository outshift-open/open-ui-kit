 ...
 * No direct replacement has been identified for `AWSServicesEgressOnlyInterentGateway` yet — it remains available via
 * `LegacyIcons.AWSServicesEgressOnlyInterentGateway` until migrated.
 */
