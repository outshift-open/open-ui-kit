 ...
 * No direct replacement has been identified for `AWSServicesElasticLoadBalancing` yet — it remains available via
 * `LegacyIcons.AWSServicesElasticLoadBalancing` until migrated.
 */
