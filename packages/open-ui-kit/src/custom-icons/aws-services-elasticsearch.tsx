 ...
 * No direct replacement has been identified for `AWSServicesElasticsearch` yet — it remains available via
 * `LegacyIcons.AWSServicesElasticsearch` until migrated.
 */
