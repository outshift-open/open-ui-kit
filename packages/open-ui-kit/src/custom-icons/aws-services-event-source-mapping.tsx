 ...
 * No direct replacement has been identified for `AWSServicesEventSourceMapping` yet — it remains available via
 * `LegacyIcons.AWSServicesEventSourceMapping` until migrated.
 */
