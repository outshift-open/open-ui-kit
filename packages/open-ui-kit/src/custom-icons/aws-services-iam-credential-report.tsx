 ...
 * No direct replacement has been identified for `AWSServicesIAMCredentialReport` yet — it remains available via
 * `LegacyIcons.AWSServicesIAMCredentialReport` until migrated.
 */
