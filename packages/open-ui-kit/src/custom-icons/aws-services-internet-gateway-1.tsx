 ...
 * No direct replacement has been identified for `AWSServicesInternetGateway1` yet — it remains available via
 * `LegacyIcons.AWSServicesInternetGateway1` until migrated.
 */
