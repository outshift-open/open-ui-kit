 ...
 * No direct replacement has been identified for `AWSServicesInternetGateway` yet — it remains available via
 * `LegacyIcons.AWSServicesInternetGateway` until migrated.
 */
