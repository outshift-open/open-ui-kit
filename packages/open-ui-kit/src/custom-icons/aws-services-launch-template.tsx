 ...
 * No direct replacement has been identified for `AWSServicesLaunchTemplate` yet — it remains available via
 * `LegacyIcons.AWSServicesLaunchTemplate` until migrated.
 */
