 ...
 * No direct replacement has been identified for `AWSServicesSageMakerNotebook` yet — it remains available via
 * `LegacyIcons.AWSServicesSageMakerNotebook` until migrated.
 */
