 ...
 * No direct replacement has been identified for `AWSServicesServerCertificate` yet — it remains available via
 * `LegacyIcons.AWSServicesServerCertificate` until migrated.
 */
