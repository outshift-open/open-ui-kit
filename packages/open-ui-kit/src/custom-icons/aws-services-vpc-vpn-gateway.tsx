 ...
 * No direct replacement has been identified for `AWSServicesVPCVPNGateway` yet — it remains available via
 * `LegacyIcons.AWSServicesVPCVPNGateway` until migrated.
 */
