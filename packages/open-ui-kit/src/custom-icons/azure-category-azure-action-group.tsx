 ...
 * No direct replacement has been identified for `AzureCategoryAzureActionGroup` yet — it remains available via
 * `LegacyIcons.AzureCategoryAzureActionGroup` until migrated.
 */
