 ...
 * No direct replacement has been identified for `AzureCategoryIdentitySecurity` yet — it remains available via
 * `LegacyIcons.AzureCategoryIdentitySecurity` until migrated.
 */
