 ...
 * No direct replacement has been identified for `AzureCategoryMachineLearning` yet — it remains available via
 * `LegacyIcons.AzureCategoryMachineLearning` until migrated.
 */
