 ...
 * No direct replacement has been identified for `AzureServicesAzureAdvancedThreatProtection` yet — it remains available via
 * `LegacyIcons.AzureServicesAzureAdvancedThreatProtection` until migrated.
 */
