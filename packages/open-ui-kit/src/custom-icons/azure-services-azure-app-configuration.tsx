 ...
 * No direct replacement has been identified for `AzureServicesAzureAppConfiguration` yet — it remains available via
 * `LegacyIcons.AzureServicesAzureAppConfiguration` until migrated.
 */
