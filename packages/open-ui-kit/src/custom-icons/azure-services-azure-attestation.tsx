 ...
 * No direct replacement has been identified for `AzureServicesAzureAttestation` yet — it remains available via
 * `LegacyIcons.AzureServicesAzureAttestation` until migrated.
 */
