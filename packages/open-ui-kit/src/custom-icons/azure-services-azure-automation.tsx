 ...
 * No direct replacement has been identified for `AzureServicesAzureAutomation` yet — it remains available via
 * `LegacyIcons.AzureServicesAzureAutomation` until migrated.
 */
