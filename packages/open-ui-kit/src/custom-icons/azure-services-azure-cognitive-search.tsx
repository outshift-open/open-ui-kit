 ...
 * No direct replacement has been identified for `AzureServicesAzureCognitiveSearch` yet — it remains available via
 * `LegacyIcons.AzureServicesAzureCognitiveSearch` until migrated.
 */
