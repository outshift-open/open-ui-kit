 ...
 * No direct replacement has been identified for `AzureServicesAzureContainerRegistry` yet — it remains available via
 * `LegacyIcons.AzureServicesAzureContainerRegistry` until migrated.
 */
