 ...
 * No direct replacement has been identified for `AzureServicesAzureDataFactory` yet — it remains available via
 * `LegacyIcons.AzureServicesAzureDataFactory` until migrated.
 */
