 ...
 * No direct replacement has been identified for `AzureServicesAzureDatabricks` yet — it remains available via
 * `LegacyIcons.AzureServicesAzureDatabricks` until migrated.
 */
