 ...
 * No direct replacement has been identified for `AzureServicesAzureFrontDoor` yet — it remains available via
 * `LegacyIcons.AzureServicesAzureFrontDoor` until migrated.
 */
