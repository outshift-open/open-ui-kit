 ...
 * No direct replacement has been identified for `AzureServicesAzureMonitor` yet — it remains available via
 * `LegacyIcons.AzureServicesAzureMonitor` until migrated.
 */
