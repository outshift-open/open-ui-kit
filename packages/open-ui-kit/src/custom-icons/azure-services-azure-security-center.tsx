 ...
 * No direct replacement has been identified for `AzureServicesAzureSecurityCenter` yet — it remains available via
 * `LegacyIcons.AzureServicesAzureSecurityCenter` until migrated.
 */
