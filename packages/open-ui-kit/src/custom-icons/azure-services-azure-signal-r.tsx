 ...
 * No direct replacement has been identified for `AzureServicesAzureSignalR` yet — it remains available via
 * `LegacyIcons.AzureServicesAzureSignalR` until migrated.
 */
