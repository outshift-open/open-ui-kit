 ...
 * No direct replacement has been identified for `AzureServicesAzureStorage` yet — it remains available via
 * `LegacyIcons.AzureServicesAzureStorage` until migrated.
 */
