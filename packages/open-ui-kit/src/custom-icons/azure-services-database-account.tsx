 ...
 * No direct replacement has been identified for `AzureServicesDatabaseAccount` yet — it remains available via
 * `LegacyIcons.AzureServicesDatabaseAccount` until migrated.
 */
