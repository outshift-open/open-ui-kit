 ...
 * No direct replacement has been identified for `AzureServicesMachineLearning` yet — it remains available via
 * `LegacyIcons.AzureServicesMachineLearning` until migrated.
 */
