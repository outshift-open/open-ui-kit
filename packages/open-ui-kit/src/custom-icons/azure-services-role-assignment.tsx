 ...
 * No direct replacement has been identified for `AzureServicesRoleAssignment` yet — it remains available via
 * `LegacyIcons.AzureServicesRoleAssignment` until migrated.
 */
