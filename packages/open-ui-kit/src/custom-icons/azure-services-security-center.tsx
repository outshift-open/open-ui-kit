 ...
 * No direct replacement has been identified for `AzureServicesSecurityCenter` yet — it remains available via
 * `LegacyIcons.AzureServicesSecurityCenter` until migrated.
 */
