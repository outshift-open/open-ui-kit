 ...
 * No direct replacement has been identified for `AzureServicesVirtualMachine` yet — it remains available via
 * `LegacyIcons.AzureServicesVirtualMachine` until migrated.
 */
