 ...
 * No direct replacement has been identified for `BitbucketColor` yet — it remains available via
 * `LegacyIcons.BitbucketColor` until migrated.
 */
export function BitbucketColor(props: SvgIconProps) {
  return (
    <SvgIcon {...props}>
      <svg
        width="24"
