 ...
 * No direct replacement has been identified for `DownloadOutline` yet — it remains available via
 * `LegacyIcons.DownloadOutline` until migrated.
 */
export function DownloadOutline(props: SvgIconProps) {
  return (
    <SvgIcon {...props}>
      <svg
        width="24"
