 ...
 * No direct replacement has been identified for `GCPCategoryIdentitySecurity1` yet — it remains available via
 * `LegacyIcons.GCPCategoryIdentitySecurity1` until migrated.
 */
