 ...
 * No direct replacement has been identified for `GCPCategoryIdentitySecurity` yet — it remains available via
 * `LegacyIcons.GCPCategoryIdentitySecurity` until migrated.
 */
