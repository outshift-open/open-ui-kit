 ...
 * No direct replacement has been identified for `GCPCategoryManagementGovernance` yet — it remains available via
 * `LegacyIcons.GCPCategoryManagementGovernance` until migrated.
 */
