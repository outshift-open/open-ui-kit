 ...
 * No direct replacement has been identified for `GCPCategoryStorage` yet — it remains available via
 * `LegacyIcons.GCPCategoryStorage` until migrated.
 */
  ...
  return (
    <SvgIcon {...props}>
      <svg
        ...
        fill="none"
      >
        <path fill="currentColor" d="M20 5.794h-1.6v5.6H20v-5.6Z" />
        <path
          fill="currentColor"
          fillRule="evenodd"
