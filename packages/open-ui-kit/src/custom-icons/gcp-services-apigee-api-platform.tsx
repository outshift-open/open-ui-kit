 ...
 * No direct replacement has been identified for `GCPServicesApigeeAPIPlatform` yet — it remains available via
 * `LegacyIcons.GCPServicesApigeeAPIPlatform` until migrated.
 */
