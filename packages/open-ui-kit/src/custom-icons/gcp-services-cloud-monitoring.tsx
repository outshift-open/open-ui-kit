 ...
 * No direct replacement has been identified for `GCPServicesCloudMonitoring` yet — it remains available via
 * `LegacyIcons.GCPServicesCloudMonitoring` until migrated.
 */
  ...
  return (
    <SvgIcon {...props}>
      <svg
        ...
        fill="none"
      >
        <path fill="currentColor" d="M13.285 16.43h-2.33v2.64h2.33v-2.64Z" />
        <path
          fill="currentColor"
