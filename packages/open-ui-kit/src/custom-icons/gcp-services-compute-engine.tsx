 ...
 * No direct replacement has been identified for `GCPServicesComputeEngine` yet — it remains available via
 * `LegacyIcons.GCPServicesComputeEngine` until migrated.
 */
