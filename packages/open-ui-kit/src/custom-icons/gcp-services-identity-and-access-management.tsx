 ...
 * No direct replacement has been identified for `GCPServicesIdentityAndAccessManagement` yet — it remains available via
 * `LegacyIcons.GCPServicesIdentityAndAccessManagement` until migrated.
 */
