 ...
 * No direct replacement has been identified for `GCPServicesInstanceGroup` yet — it remains available via
 * `LegacyIcons.GCPServicesInstanceGroup` until migrated.
 */
