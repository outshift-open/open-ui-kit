 ...
 * No direct replacement has been identified for `GCPServicesManagedInstanceGroup` yet — it remains available via
 * `LegacyIcons.GCPServicesManagedInstanceGroup` until migrated.
 */
