 ...
 * No direct replacement has been identified for `GCPServicesNetworkEndpointGroup` yet — it remains available via
 * `LegacyIcons.GCPServicesNetworkEndpointGroup` until migrated.
 */
