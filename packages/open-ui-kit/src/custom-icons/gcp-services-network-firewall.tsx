 ...
 * No direct replacement has been identified for `GCPServicesNetworkFirewall` yet — it remains available via
 * `LegacyIcons.GCPServicesNetworkFirewall` until migrated.
 */
