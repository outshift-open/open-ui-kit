 ...
 * No direct replacement has been identified for `GCPServicesPubsub` yet — it remains available via
 * `LegacyIcons.GCPServicesPubsub` until migrated.
 */
  ...
  return (
    <SvgIcon {...props}>
      ...
      >
        ...
        />
        <path fill="currentColor" d="M12.815 5.794h-1.388v7.022h1.388V5.794Z" />
        <path
          fill="currentColor"
