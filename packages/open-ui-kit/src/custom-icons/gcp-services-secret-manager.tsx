 ...
 * No direct replacement has been identified for `GCPServicesSecretManager` yet — it remains available via
 * `LegacyIcons.GCPServicesSecretManager` until migrated.
 */
