 ...
 * No direct replacement has been identified for `GCPServicesSecurityCenter` yet — it remains available via
 * `LegacyIcons.GCPServicesSecurityCenter` until migrated.
 */
