 ...
 * No direct replacement has been identified for `GCPServicesServiceAccount` yet — it remains available via
 * `LegacyIcons.GCPServicesServiceAccount` until migrated.
 */
