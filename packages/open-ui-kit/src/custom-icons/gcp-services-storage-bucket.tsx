 ...
 * No direct replacement has been identified for `GCPServicesStorageBucket` yet — it remains available via
 * `LegacyIcons.GCPServicesStorageBucket` until migrated.
 */
