 ...
 * No direct replacement has been identified for `GCPServicesTargetInstance` yet — it remains available via
 * `LegacyIcons.GCPServicesTargetInstance` until migrated.
 */
