...
/**
 * @deprecated Use `InfoCircleOutline` from `Icons` (packages/open-ui-kit/src/icons) instead.
 * This legacy version remains available via `LegacyIcons.InfoCircleOutline`.
 */
