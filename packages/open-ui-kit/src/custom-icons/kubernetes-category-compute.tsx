 ...
 * No direct replacement has been identified for `KubernetesCategoryCompute` yet — it remains available via
 * `LegacyIcons.KubernetesCategoryCompute` until migrated.
 */
