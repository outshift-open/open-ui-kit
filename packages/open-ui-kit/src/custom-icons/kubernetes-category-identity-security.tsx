 ...
 * No direct replacement has been identified for `KubernetesCategoryIdentitySecurity` yet — it remains available via
 * `LegacyIcons.KubernetesCategoryIdentitySecurity` until migrated.
 */
