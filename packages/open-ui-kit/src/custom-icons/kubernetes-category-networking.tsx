 ...
 * No direct replacement has been identified for `KubernetesCategoryNetworking` yet — it remains available via
 * `LegacyIcons.KubernetesCategoryNetworking` until migrated.
 */
