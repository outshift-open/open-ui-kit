 ...
 * No direct replacement has been identified for `KubernetesCategoryStorage` yet — it remains available via
 * `LegacyIcons.KubernetesCategoryStorage` until migrated.
 */
