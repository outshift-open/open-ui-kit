 ...
 * No direct replacement has been identified for `KubernetesServicesClusterRoleBinding` yet — it remains available via
 * `LegacyIcons.KubernetesServicesClusterRoleBinding` until migrated.
 */
