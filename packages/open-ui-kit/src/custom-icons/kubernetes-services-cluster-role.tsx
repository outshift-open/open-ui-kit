 ...
 * No direct replacement has been identified for `KubernetesServicesClusterRole` yet — it remains available via
 * `LegacyIcons.KubernetesServicesClusterRole` until migrated.
 */
