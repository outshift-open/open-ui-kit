 ...
 * No direct replacement has been identified for `KubernetesServicesConfigMap` yet — it remains available via
 * `LegacyIcons.KubernetesServicesConfigMap` until migrated.
 */
