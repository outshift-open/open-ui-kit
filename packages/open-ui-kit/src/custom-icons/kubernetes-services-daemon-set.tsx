 ...
 * No direct replacement has been identified for `KubernetesServicesDaemonSet` yet — it remains available via
 * `LegacyIcons.KubernetesServicesDaemonSet` until migrated.
 */
