 ...
 * No direct replacement has been identified for `KubernetesServicesDeployment` yet — it remains available via
 * `LegacyIcons.KubernetesServicesDeployment` until migrated.
 */
