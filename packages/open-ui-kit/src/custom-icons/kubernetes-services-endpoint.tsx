 ...
 * No direct replacement has been identified for `KubernetesServicesEndpoint` yet — it remains available via
 * `LegacyIcons.KubernetesServicesEndpoint` until migrated.
 */
