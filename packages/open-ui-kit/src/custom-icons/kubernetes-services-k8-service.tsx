 ...
 * No direct replacement has been identified for `KubernetesServicesK8Service` yet — it remains available via
 * `LegacyIcons.KubernetesServicesK8Service` until migrated.
 */
