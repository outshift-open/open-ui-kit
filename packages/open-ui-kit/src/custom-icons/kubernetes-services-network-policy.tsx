 ...
 * No direct replacement has been identified for `KubernetesServicesNetworkPolicy` yet — it remains available via
 * `LegacyIcons.KubernetesServicesNetworkPolicy` until migrated.
 */
