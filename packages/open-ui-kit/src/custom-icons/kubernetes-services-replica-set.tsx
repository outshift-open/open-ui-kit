 ...
 * No direct replacement has been identified for `KubernetesServicesReplicaSet` yet — it remains available via
 * `LegacyIcons.KubernetesServicesReplicaSet` until migrated.
 */
