 ...
 * No direct replacement has been identified for `KubernetesServicesRoleBinding` yet — it remains available via
 * `LegacyIcons.KubernetesServicesRoleBinding` until migrated.
 */
