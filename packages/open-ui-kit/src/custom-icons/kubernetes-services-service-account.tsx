 ...
 * No direct replacement has been identified for `KubernetesServicesServiceAccount` yet — it remains available via
 * `LegacyIcons.KubernetesServicesServiceAccount` until migrated.
 */
