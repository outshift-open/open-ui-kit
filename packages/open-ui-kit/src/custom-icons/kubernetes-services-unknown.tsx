 ...
 * No direct replacement has been identified for `KubernetesServicesUnknown` yet — it remains available via
 * `LegacyIcons.KubernetesServicesUnknown` until migrated.
 */
