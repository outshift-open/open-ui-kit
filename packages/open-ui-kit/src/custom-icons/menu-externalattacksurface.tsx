 ...
 * No direct replacement has been identified for `MenuExternalAttackSurface` yet — it remains available via
 * `LegacyIcons.MenuExternalAttackSurface` until migrated.
 */
    ...
    <SvgIcon {...props}>
      ...
      >
        ...
        <path
          ...
          clipRule="evenodd"
        />
        <path fill="currentColor" d="M20 19a2 2 0 1 1-4 0 2 2 0 0 1 4 0Z" />
