...
// The Figma navigation item (frame node 179634:5030) paints the Dashboard mark
// with three tones rather than a single flat fill, and swaps the whole ramp
// between the unselected and selected states:
//
//   unselected   tall block  Brand/Icon/Secondary/Weak
//                bars        Brand/Icon/Secondary/Medium
//                square      Brand/Icon/Secondary/Default
//   selected     tall block  Brand/Icon/Primary/Default
//                bars        Brand/Icon/Primary/Default
//                square      Brand/Icon/Primary/Strong
//
// The shapes therefore cannot use `currentColor` — the item only carries one
// inherited color, which is why all three variants rendered identically before.
type DashboardTones = {
  block: string;
  bars: string;
  square: string;
...
const DashboardMark = ({
  tones,
  ...props
}: SvgIconProps & { tones: DashboardTones }) => (
  <SvgIcon {...props}>
    <svg
