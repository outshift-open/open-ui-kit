 ...
 * No direct replacement has been identified for `OracleCategoryNetworking` yet — it remains available via
 * `LegacyIcons.OracleCategoryNetworking` until migrated.
 */
