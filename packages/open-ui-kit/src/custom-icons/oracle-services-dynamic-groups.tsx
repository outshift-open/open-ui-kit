 ...
 * No direct replacement has been identified for `OracleServicesDynamicGroups` yet — it remains available via
 * `LegacyIcons.OracleServicesDynamicGroups` until migrated.
 */
