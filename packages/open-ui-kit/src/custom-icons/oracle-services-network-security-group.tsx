 ...
 * No direct replacement has been identified for `OracleServicesNetworkSecurityGroup` yet — it remains available via
 * `LegacyIcons.OracleServicesNetworkSecurityGroup` until migrated.
 */
