 ...
 * No direct replacement has been identified for `OracleServicesObjectStorage` yet — it remains available via
 * `LegacyIcons.OracleServicesObjectStorage` until migrated.
 */
