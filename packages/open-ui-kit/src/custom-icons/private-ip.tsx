 ...
 * No direct replacement has been identified for `PrivateIP` yet — it remains available via
 * `LegacyIcons.PrivateIP` until migrated.
 */
  ...
  return (
    <SvgIcon {...props}>
      <svg
        ...
        fill="none"
      >
        <path fill="currentColor" d="M10.144 12.66H9v5.84h1.144v-5.84Z" />
        <path
          fill="currentColor"
          fillRule="evenodd"
