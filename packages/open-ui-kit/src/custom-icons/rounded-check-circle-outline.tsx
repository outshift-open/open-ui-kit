 ...
 * No direct replacement has been identified for `RoundedCheckCircleOutline` yet — it remains available via
 * `LegacyIcons.RoundedCheckCircleOutline` until migrated.
 */
