 ...
 * No direct replacement has been identified for `SettingsMenuIntegrations` yet — it remains available via
 * `LegacyIcons.SettingsMenuIntegrations` until migrated.
 */
