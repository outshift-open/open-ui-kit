...
import {
  illustrationGradientEnd,
  illustrationGradientStart,
  illustrationShell,
  illustrationStroke,
  lightBlue500,
      ...
      component={() => (
        ...
        >
          ...
          <defs>
            ...
            >
              <stop stopColor={illustrationGradientStart} />
              <stop offset="1" stopColor={illustrationGradientEnd} />
            </linearGradient>
          </defs>
        </svg>
      )}
