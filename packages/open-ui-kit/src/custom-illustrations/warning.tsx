...
import {
  grey0,
  illustrationWarningGradientEnd,
  illustrationWarningGradientStart,
  lightOrange600,
    ...
    <SvgIcon {...props}>
      ...
      >
        ...
        <defs>
          ...
          >
            <stop stopColor={illustrationWarningGradientStart} />
            <stop offset="1" stopColor={illustrationWarningGradientEnd} />
          </linearGradient>
        </defs>
      </svg>
    </SvgIcon>
